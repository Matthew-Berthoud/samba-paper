...
%
Using a proxy re-encryption implementation we ported to Go\footnote{\url{https://github.com/etclab/pre}}, we wrote a \SystemName{\url{https://github.com/etclab/samba}} library to perform the cryptographic operations that will be needed in the eventual \SystemName extension of a FaaS library.
%
